...
sub_lib('flashinfer_batch_paged_decode', batch_paged_decode, cuda_copts() + common_copts + debug_copts)
sub_lib('flashinfer_batch_ragged_prefill', batch_ragged_prefill, cuda_copts() + common_copts + debug_copts)
sub_lib('flashinfer_single_decode', single_prefill, cuda_copts() + common_copts + debug_copts)
sub_lib('flashinfer_single_prefill', single_decode, cuda_copts() + common_copts + debug_copts)
sub_lib('flashinfer_sm90', [":generated_sm90"], sm90_cuda_copts + debug_copts)
