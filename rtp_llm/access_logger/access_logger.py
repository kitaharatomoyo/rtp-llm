...
def init_logger(logger_name: str, log_path: str, rank_id: Optional[int] = None, server_id: Optional[int] = None, async_mode: bool = True) -> None:
    access_logger = logging.getLogger(logger_name)
    handler = get_handler(f"{log_path}", rank_id, server_id, async_mode)
...
class AccessLogger:
    def __init__(self, rank_id: Optional[int] = None, server_id: Optional[int] = None, async_mode: bool = True) -> None:
        init_logger(ACCESS_LOGGER_NAME, "access.log", rank_id, server_id, async_mode)
        init_logger(QUERY_ACCESS_LOGGER_NAME, "query_access.log", rank_id, server_id, async_mode)
...
class MMAccessLogger(AccessLogger):
    def __init__(self) -> None:
        init_logger(MM_ACCESS_LOGGER_NAME, "mm_access.log")
        init_logger(MM_QUERY_ACCESS_LOGGER_NAME, "mm_query_access.log")
